...
**Frameworks & Tools:** Node.js, React, Express, MongoDB, SQL, PyTorch, OpenCV, Power Apps, Azure DevOps  
 
---
 
## 🚀 Things I've built
 
**[Calendar Application](https://github.com/teja1412-hub/calendar-application)** — Java  
MVC + Strategy + Observer patterns. 600+ JUnit tests. Yes, I tested it properly. This is something similar to a Google Calendar, including the functionalities for multi-day, repeated events, editing scope for these repeating events, cross-calendar functionalities, etc. For more, check out the repo link for a detailed description.
 
**[Video-based Classification, Counting and Speed
Estimation for Indian Vehicles Dataset]** (I don't hv repo link for this!! I did it way before I built a github profile😭 but I do have my thesis report for this, am gonna add another CV project which is on medical image processing, so stay tuned!) — Python · OpenCV · YOLOv8  
Studies and works on the problem of Multi-object detection and tracking models like YOLO failing for Intelligent Transportation Systems due to their focus on generic vehicles from the COCO dataset, which differ vastly from the vehicles you see on a daily basis on Indian roads, which makes the ITS tracking and use of these MOT models not so efficient to solve real-life actual problems and for automating tasks in ITS.
 
**[Kambaz LMS](https://github.com/teja1412-hub/kambaz-next-js)** — Node.js · React · MongoDB  
Full-stack Canvas-like app — auth, enrollments, course management, the works. Built solo.


<!--
**teja1412-hub/teja1412-hub** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
